/**
 * Author: omteja04
 * Created on: 24-12-2024 20:12:25
 * Description: C_Pair_Selection
 **/
...
=================================================
*/
bool can(ld x, int k, vpi &arr) {
    std::vector<ld> transformed(arr.size());
    for(int i = 0; i < arr.size(); i++) {
        transformed[i] = arr[i].fi - x * arr[i].se;
    }
