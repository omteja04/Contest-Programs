/**
 * Author: omteja04
 * Created on: 04-06-2025 21:25:51
 * Problem: Sortable_Subarrays_Easy
 * Link: https://www.codechef.com/START189B/problems/SORTSUB7EZ
 **/
#include <bits/stdc++.h>
#include <vector>
using namespace std;
...
bool isValidSubarray(const vi &arr, int start, int end) {
    ll current = -1;
    for(int i = start; i <= end; ++i) {
        ll threshold = (arr[i] - 1) / 2;
