/**
 * Author: omteja04
 * Created on: 21-05-2025 21:20:56
 * Problem: Distinct_Representations
 * Link: https://www.codechef.com/START187B/problems/DIREP
 **/
#include <bits/stdc++.h>
#include <vector>
using namespace std;
