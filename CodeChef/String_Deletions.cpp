/**
 * Author: omteja04
 * Created on: 16-07-2025 20:51:53
 * Problem: String_Deletions
 * Link: https://www.codechef.com/START195B/problems/STRDEL7
 **/
#include <bits/stdc++.h>
#include <vector>
using namespace std;
...
void levi() {
    ...
    long long z;
    if(b[0] == b[n - 1]) {
        z = min((long long) (x + y), (long long) n);
    } else {
        z = x + y + (f3(x, y) ? 1 : 0);
    }
