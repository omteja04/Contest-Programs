/**
 * Author: omteja04
 * Created on: 26-02-2025 20:42:34
 * Problem: Alternate_It
 * Link: https://www.codechef.com/START175C/problems/P4_175
 **/
...
void levi() {
    ...
    if((str.size() % 2 == 1) && abs(ones - zeros) == 1) {
        cout << 1;
        return;
    }
    if(str.size() % 2 == 0 && (ones == zeros)) {
        cout << 1;
        return;
    }
